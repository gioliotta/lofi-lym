function LoveSVG({ onClick }) {
  return (
    <svg
      onClick={onClick}
      className="w-6 hover:scale-90 duration-100"
      fill="#fc4040"
      viewBox="0 0 24 24"
    >
...
function LoveEmptySVG({ onClick }) {
  return (
    <svg
      onClick={onClick}
      className="w-6 hover:scale-125 duration-100"
      fill="#fc4040"
      viewBox="0 0 24 24"
    >
